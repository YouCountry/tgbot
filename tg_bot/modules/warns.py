...
def warn(user: User, chat: Chat, reason: str, message: Message, warner: User = None) -> str:
    ...
    if num_warns >= limit:
        ...
        if soft_warn:  # kick
            ...
            reply = "警告已达{}次，所以我把{}踢了".format(limit, mention_html(user.id, user.first_name))
        ...
        reply = "{}，你受到管理员的警告，这是第{}/{}次".format(mention_html(user.id, user.first_name), num_warns,
                                                             limit)
        if reason:
